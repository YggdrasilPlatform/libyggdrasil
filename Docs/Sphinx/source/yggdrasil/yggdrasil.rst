...
Yggdrasil is the main peripheral board of the Yggdrasil Platform. On it tons of connectors, sensor, actors and input devices can be found which can easily be interacted with from any World Board using libyggdrasil.
